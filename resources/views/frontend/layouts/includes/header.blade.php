    ...
    <div style="padding: 0; max-width: 100%;" class="container">
                                                    ...
                                                    @for($i = 1; $i <= 3; $i++)
                                                        <div class="single-cart clearfix">
                                                            <div class="cart-img f-right">
                                                                <a href="#">
                                                                    <img src="{{ asset('theme/image/624.jpg') }}" alt="عکس محصول">
                                                                </a>
                                                            </div>
                                                            ...
                                                            <div class="cart-info f-right">
                                                                <h6 class="text-capitalize">
                                                                    <a href="#" class="carttitle">
                                                                        {{ $i === 1 ? 'چاپ استیکر با لمینت' : 'چاپ مش' }}
                                                                    </a>
                                                                ...
                                                                <p style="padding:0 4px;"><span>متراژ</span> <strong>:</strong> ۱۱ متر</p>
                                                                <p style="padding:0 4px;"><span>تعداد</span> <strong>:</strong> ۳ عدد</p>
                                                                <p style="padding:0 4px;"><span>خدمات</span> <strong>:</strong> برش شکل خاص</p>
                                                                <p style="padding:0 4px;">
                                                                    <span>مبلغ</span> <strong>:</strong>
                                                                    <span style="color:#e30000;padding:0;">2500000 هزار</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    @endfor
                    ...
                    <div class="user-item account">
                        <a href="#" class="btn-auth">
                            ...
                            <div class="pc-user-pc">
                                ...
                                @else
                                    ورود
                                    <svg style="margin-top:2px;transform:rotate(90deg)"
                ...
                <div class="search-box search-box-pc">
                    ...
                    <div class="search-result">
                        <ul class="search-result-list">
                            <li><a href="#"><img src="{{ asset('theme/images/2-color.jpg') }}" alt="alt-images"> موبایل سامسونگ مدل اس ۲۲</a></li>
                            <li><a href="#"><img class="pic-1" src="{{ asset('theme/images/2-color-2.jpg---5f3fb80ae20ab.jpg') }}" alt="alt-images"> موبایل سامسونگ مدل اس ۲۲</a></li>
                            <li><a href="#"><img class="pic-1" src="{{ asset('theme/images/2-color.jpg') }}" alt="alt-images"> موبایل سامسونگ مدل اس ۲۲</a></li>
                            <li><a href="#"><img class="pic-1" src="{{ asset('theme/images/2-color-2.jpg---5f3fb80ae20ab.jpg') }}" alt="alt-images"> موبایل سامسونگ مدل اس ۲۲</a></li>
                            <li><a href="#" style="color:#f10000;border:none;">نمایش بیشتر...</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="nav-wrapper">
            ...
            <ul class="category-list-main">
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="#">برچسب های تزیینی شیشه</a></li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="main-menu2 mean-menu2">
                <ul>
                    <li><a class="link-amenu" href="{{ url('/') }}">صفحه اصلی</a></li>

                    <li>
                        <a class="link-amenu" href="{{ url('shop-category') }}">
                            محصولات <i class="fa fa-angle-down" aria-hidden="true"></i>
                        </a>
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li><a href="#">چاپ استیکر فروشگاهها</a></li>
                            ...
                            <li>
                                <a href="#">برچسب جیوه ای و دودی <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                                    <li><a href="#">برچسب جیوه ای شیشه</a></li>
                                    <li><a href="#">برچسب دودی شیشه</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="#">چاپ کاغذ دیواری <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                                    <li><a href="#">چاپ کاغذ دیواری ایرانی</a></li>
                                    <li><a href="#">چاپ کاغذ دیواری چینی</a></li>
                                    <li><a href="#">چاپ کاغذ دیواری ترک</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="#">چاپ indoor <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                                    <li>
                                        <a href="#">چاپ کتد و لمینت <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                        <ul>
                                            <li><a href="#">کتد و لمینت مات</a></li>
                                            <li><a href="#">کتد و لمینت براق</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">چاپ بک لایت</a></li>
                                    <li><a href="#">چاپ گلاسه</a></li>
                    ...
                    <li><a class="link-amenu" href="#">استعلام قیمت اختصاصی</a></li>
                    <li><a class="link-amenu" href="#">لیست قیمت</a></li>
                    <li><a class="link-amenu" href="{{ url('contact') }}">تماس با ما</a></li>
                </ul>
            </div>
